...
describe('dates', () => {
  ...
  it('formats ranges with the start year always, the end year only across years', () => {
    expect(fmtRange('2026-10-12', '2026-10-16')).toBe('2026/10/12 (一) – 10/16 (五)')
    expect(fmtRange('2027-10-12', '2027-10-16')).toBe('2027/10/12 (二) – 10/16 (六)')
    expect(fmtRange('2026-12-30', '2027-01-02')).toBe('2026/12/30 (三) – 2027/1/2 (六)')
  })
